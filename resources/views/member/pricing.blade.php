...
<body class="bg-stream-dark">
    ...
    <div class="relative">
        <div class="hidden lg:block fixed">
            <img src="{{ asset('stream/assets/images/banner1.png') }}" class="max-h-screen" alt="stream" />
        </div>
    </div>
            ...
            <div class="px-5 lg:px-[60px] pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5">
                    ...
                    <div class="font-bold text-white text-4xl lg:text-[45px] text-center capitalize leading-snug">
                        Dengan Menghidupkan Imajinasimu
                    </div>
                    ...
                    <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="text-3xl text-stream-dark font-semibold my-1">
                               Rp. {{ str_replace(',', '.', number_format($basic->price)) }}
                            </div>
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    {{ $basic->max_users }} Batasan Pengguna
                                    </span>
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        Tersedia untuk Ditonton di Ponsel atau Tablet
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                            </div>
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="text-3xl text-stream-dark font-semibold my-1">
                               Rp. {{ str_replace(',', '.', number_format($standard->price)) }}
                            </div>
                            <p class="text-sm text-stream-gray">
                                /bulan
                            </p>
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        {{ $standard->max_users }} Batasan Pengguna 
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="text-3xl text-stream-dark font-semibold my-1">
                               Rp. {{ str_replace(',', '.', number_format($silver->price)) }}
                            </div>
                            <p class="text-sm text-stream-gray">
                                /2 bulan
                            </p>
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                    {{ $silver->max_users }} Batasan Pengguna
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        kualitas vidio sangat bagus Full HD 1080p
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        Tersedia untuk Ditonton di Ponsel, Tablet, komputer, TV
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        Streaming di Berbagai Perangkat
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                            </div>
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="text-3xl text-stream-dark font-semibold my-1">
                               Rp. {{ str_replace(',', '.', number_format($gold->price)) }}
                            </div>
                            <p class="text-sm text-stream-gray">
                                /2 bulan
                            </p>
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                    {{ $gold->max_users }} Batasan Pengguna
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
                                <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        kualitas vidio sangat bagus Ultra HD 4K
                                    </span>
                                    <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                                </div>
                                <!-- benefits -->
