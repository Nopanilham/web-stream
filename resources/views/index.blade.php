    ...
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
                ...
                <div class="hidden w-full lg:block" id="navigation">
                    <div
                        ...
                        <div class="flex flex-col w-full font-normal lg:w-auto lg:gap-12 lg:items-center lg:flex-row">
                            <a href="{{ route('pricing') }}" class="nav-link-item">Mulai Berlangganan</a>
                        </div>

                        <a href="/" class="hidden lg:block -ml-36">
                            <span class="text-white text-5xl font-semibold">STREAM</span>
                        </a>
                        
                        <div class="flex flex-col w-full font-normal lg:w-auto lg:gap-12 lg:items-center lg:flex-row">
                            <a href="{{ route('member.login') }}"
                                class="px-8 py-3 mt-3 text-center outline outline-2 outline-stream-gray rounded-3xl lg:mt-0">
                                <span class="text-base text-normal text-stream-gray">Masuk</span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-[100px] flex flex-col items-center gap-5 px-3 relative">
            <p class="text-sky-300 text-base font-semibold">
                SELAMAT DATANG DI STREAM
            </p>
            <div class="font-bold text-white text-4xl lg:text-[45px] text-center capitalize leading-snug">
                Dapatkan inspirasi tak terbatas <br class="hidden md:block" /> dari film-film hebat
            </div>
            <p class="text-base text-stream-gray text-center leading-7">
                Nikmati hiburan untuk diri sendiri dan keluarga <br class="hidden lg:block" />
                dengan streaming di mana saja dan kapan saja.
            </p>

            <div class="font-bold text-white text-4xl lg:text-[20px] text-center capitalize leading-snug">
                Siap untuk menonton? Daftarkan dirimu sekarang 
            </div>
            <a href="{{ route('member.register') }}" class="mt-3 rounded-full bg-indigo-600 text-center py-3 px-11">
                <span class="text-white font-semibold text-base">DAFTAR</span>
            </a>
        </section>
        ...
        <section class="relative">
            ...
            <video-js
                ...
                id="stream-video">
                <source src="https://vidio-lobby.s3.ap-southeast-1.amazonaws.com/Opening+Dolby+Biasa+Ada+di+Bioskop.mp4" type="video/mp4" />
